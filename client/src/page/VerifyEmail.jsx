                    ...
                    <form onSubmit={handleVerifyAndSignup}>
                        <OtpInput
                            ...
                            renderInput={(props) => (
                                ...
                                className="w-[48px] lg:w-[60px] border-0 bg-richblack-800 rounded-[0.5rem] text-richblack-5 aspect-square text-center focus:border-0 focus:outline-2 focus:outline-yellow-300"
                                />
                            )}
                            containerStyle={{
